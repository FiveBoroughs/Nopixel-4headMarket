...
import { AlertTriangle, Binary, Bug, Skull } from "lucide-react";
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-black/50 p-6 border border-[#8b0000] rounded-lg backdrop-blur-sm">
              <div className="flex items-center gap-2 mb-4">
                ...
                <h2 className="text-xl text-[#8b0000] toxic-shadow">
                  DANGER ZONE
                </h2>
              </div>
              <p className="text-gray-400 glitch">
                You have entered a restricted area. Proceed with extreme
                caution.
              </p>
            </div>
            ...
            <div className="bg-black/50 p-6 border border-[#39ff14] rounded-lg backdrop-blur-sm">
              <div className="flex items-center gap-2 mb-4">
                ...
                <h2 className="text-xl text-[#39ff14] toxic-shadow">
                  SYSTEM BREACH
                </h2>
              </div>
